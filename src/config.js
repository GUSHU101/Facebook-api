...
module.exports = {
    ...
    // queueing, retries and platform cooldowns. Older orders remain business
    // history; their occurrence time must never be rewritten as "now".
    shopifyReconcileLookbackHours: readBoundedInt('SHOPIFY_RECONCILE_LOOKBACK_HOURS', 144, 6 * 24),
